...
Public Sub Main()
    ...
    Dim strWin As String, strHost As String, strPrgFil As String
    ...
    strProgram = Chr(34) & strPrgFil & "\Earthlink\ProDialer\ProDial.exe" & Chr(34)
    'strWorkingDir = strWin & "\system32\"
    strWorkingDir = strPrgFil & "\Earthlink\ProDialer\"
